...
sctl_read_bytes=$(echo "$smartctl" | grep "Read bytes:" | awk '{print $3}')
 ...
 echo $bio_write_io,$bio_read_io,$bio_write_bytes,$bio_read_bytes,$stats_write_io,$stats_read_io,$stats_write_sectors,$stats_read_sectors,$sctl_write_io,$sctl_read_io,$sctl_write_bytes,$sctl_read_bytes
